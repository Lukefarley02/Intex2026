...
{
    [Key][Column("partner_id")] public int PartnerId { get; set; }
    [Column("partner_name")] public string PartnerName { get; set; } = "";
    [Column("partner_type")] public string PartnerType { get; set; } = ""; // Organization, Individual
    [Column("role_type")] public string RoleType { get; set; } = "";       // SafehouseOps, Evaluation, Education, Logistics
