...
public class InKindDonationItem
{
    ...
    [Column("item_category")] public string ItemCategory { get; set; } = ""; // SchoolMaterials, Food, Supplies, Medical
    ...
    [Column("intended_use")] public string? IntendedUse { get; set; } // Health, Shelter, Hygiene, Education
    [Column("received_condition")] public string ReceivedCondition { get; set; } = "Good"; // New, Good, Fair
}
